...
# keys commit verbs), fires edge presses immediately, repeats held verbs at the flow cadence, and emits
# verb_requested without knowing anything about legality — the scene root validates and executes.

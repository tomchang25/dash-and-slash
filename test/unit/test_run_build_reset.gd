...
# a single clear() call must drop channel entries, owned-artifact records, and Mobility triggers.
extends GutTest

func test_clear_resets_entries_artifacts_and_triggers_together() -> void:

...
| 4b    | Dash-triggered Majors           | Guard Shredder and Execution as dash-triggered Majors, using the shared triggered-effect seam, honest outcome previews, and debug wiring through the Phase 04a controls.                                                                                |

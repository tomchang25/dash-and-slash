...
- The input layer emits command-intent events (Alt mode toggle, left confirm, right cancel) rather than Dash/Smash-specific verbs; the arena root maps Mobility Mode confirms through the run-build payload.
...
1. Alt toggles Attack Mode versus Mobility Mode; left click confirms the active mode; right click cancels pending/armed commands.

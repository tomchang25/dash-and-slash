...
Dash & Slash is a Godot 4.6 project built on the data-driven template base layer with action-RPG conventions. Detailed architecture, workflow, and standards guidance lives in `dev/agent_rules/agent_startup.md` and the files it references.
